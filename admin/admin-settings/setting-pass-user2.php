<?php
  ...
  if ( isset($_POST["submit"])) {
    ...
    if ( setPassUser2($_POST, $id_anggota) > 0) {
...
<div class="d-flex justify-content-center">
    <div class="card text-bg-secondary" style="width: 25rem; margin-top: 100px; border-radius: 20px;">
        <div class="card-body" >
...
<br>
<h4 class="d-flex justify-content-center">Set Password Anggota</h4>
                    <br>
                ...
                <div class="form-group">
                  ...
                  <input type="password" class="form-control" id="Password" name="kpass">
                </div>
                <br><br>
                <button name="submit" type="submit" class="btn btn-success btn-block" style="border-radius: 30px;">Apply</button>
